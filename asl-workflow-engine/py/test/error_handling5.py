...
#
# Run with:
# PYTHONPATH=.. python3 error_handling5.py
#
"""
...
the Map State and includes Map State Retriers and Catchers
"""
      ...
      "Iterator": {
        ...
        "States": {
          ...
          "FailState": {
            ...
            "Cause": "Iterator failed! Reached FailState"
          }
        }
      },
      "Retry" : [
        {
          "ErrorEquals": [ "IteratorFailed" ],
          "IntervalSeconds": 3,
          "MaxAttempts": 2,
          "BackoffRate": 1.5
        },
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="error_handling5")
    ...
    create_tracer("error_handling5", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling5"
    ...
    def create_state_machines():
        ...
        try:
            response = sfn.create_state_machine(
                name="error_handling5", definition=ASL,
