...
should never be reached in this example because the only error is a timeout
...
if __name__ == '__main__':
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling1_state_machine"
    ...
    def create_state_machines():
        ...
        try:
            ...
            response = sfn.create_state_machine(
                name="error_handling1_state_machine", definition=ASL,
