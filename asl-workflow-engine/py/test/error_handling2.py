...
if __name__ == '__main__':
    ...
    create_tracer("error_handling2", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling2_state_machine"
    ...
    def create_state_machines():
        ...
        try:
            ...
            response = sfn.create_state_machine(
                name="error_handling2_state_machine", definition=ASL,
