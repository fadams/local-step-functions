...
#
# Run with:
# PYTHONPATH=.. python3 parallel3.py
#
"""
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="parallel3")
    ...
    create_tracer("parallel3", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:parallel3"
