...
#
# Run with:
# PYTHONPATH=.. python3 errored_parameters.py
#
"""
This example tests Parameters (ASL Payload Template) that error at run time,
in this case because the JSONPath doesn't match. It is primarily intended to
help test that a useful message gets sent via OpenTracing/Jaeger.
"""
...
ASL = """{
    ...
    "StartAt": "ErroredParameters",
    "States": {
        "ErroredParameters": {
            "Comment": "This should fail before the Task gets invoked because neither item-a nor item-b fields exist on the input.",
            "Type": "Task",
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name='errored_parameters_state_machine')
    ...
    create_tracer("errored_parameters_state_machine", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:errored_parameters_state_machine"
    ...
    def create_state_machines():
        ...
        try:
            ...
            response = sfn.create_state_machine(
                name="errored_parameters_state_machine", definition=ASL,
