...
#
# Run with:
# PYTHONPATH=.. python3 error_handling11.py
#
"""
...
This example is similar to error_handling10, but replaces the Task state with
a timeout in the nested Parallel state with a Wait state so that we can
illustrate cancellation of pending Wait states when states in Map Iterators or
Parallel Branches fail.
"""
          ...
          "States": {
            "LookupAliases": {
              ...
              "Branches": [
                ...
                {
                  "StartAt": "WaitForLookupAlias2",
                  "States": {
                    "WaitForLookupAlias2": {
                        "Type": "Wait",
                        "Comment": "In this example the Wait state is intentionally cancelled.",
                        "Seconds": 20,
                        "Next": "LookupAlias2"
                    },
                    "LookupAlias2": {
        ...
        },
        {
          ...
          "States": {
            "LookupPhone": {
              ...
              "Comment": "In this example the Task should timeout (and thus fail the Branch).",
              "TimeoutSeconds": 10,
              "End": true
            }
          }
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="error_handling11")
    ...
    create_tracer("error_handling11", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling11"
    ...
    def create_state_machines():
        ...
        try:
            response = sfn.create_state_machine(
                name="error_handling11", definition=ASL,
