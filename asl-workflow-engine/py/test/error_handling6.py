...
#
# Run with:
# PYTHONPATH=.. python3 error_handling6.py
#
"""
...
This example is based on parallel2.py, but adds a Fail State to deliberately fail.
"""
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="error_handling6")
    ...
    create_tracer("error_handling6", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling6"
    ...
    def create_state_machines():
        ...
        try:
            response = sfn.create_state_machine(
                name="error_handling6", definition=ASL,
