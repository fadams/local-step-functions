...
#
# Run with:
# PYTHONPATH=.. python3 error_handling10.py
#
"""
...
This example is based on parallel4.py, but replaces Pass States in the Branches
with Task States with Timeouts to deliberately fail the Parallel State.
"""
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="error_handling10")
    ...
    create_tracer("error_handling10", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling10"
    ...
    def create_state_machines():
        ...
        try:
            response = sfn.create_state_machine(
                name="error_handling10", definition=ASL,
