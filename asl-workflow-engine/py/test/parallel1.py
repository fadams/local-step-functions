...
#
# Run with:
# PYTHONPATH=.. python3 parallel1.py
#
"""
...
This example is a minimal example to illustrate use of the Parallel State
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="parallel1")
    ...
    create_tracer("parallel1", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:parallel1"
