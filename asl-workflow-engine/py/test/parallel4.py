...
#
# Run with:
# PYTHONPATH=.. python3 parallel4.py
#
"""
...
This example is based on parallel2.py, but moves the branch containing the
nested Parallel state to be the first branch.
"""
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="parallel4")
    ...
    create_tracer("parallel4", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:parallel4"
