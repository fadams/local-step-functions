...
#
# Run with:
# PYTHONPATH=.. python3 error_handling8.py
#
"""
...
This test is based on map1.py but replaces a Pass State in the Iterator with
a Task State with a Timeout to deliberately fail the Map State.
"""
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="error_handling8")
    ...
    create_tracer("error_handling8", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling8"
    ...
    def create_state_machines():
        ...
        try:
            response = sfn.create_state_machine(
                name="error_handling8", definition=ASL,
