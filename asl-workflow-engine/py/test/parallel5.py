...
#
# Run with:
# PYTHONPATH=.. python3 parallel5.py
#
"""
...
This example is based on parallel4.py, but adds a Fail State to deliberately fail.
"""
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="parallel5")
    ...
    create_tracer("parallel5", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:parallel5"
