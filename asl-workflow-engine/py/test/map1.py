...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="map1")
    ...
    create_tracer("map1", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:map1"
