...
#
# Run with:
# PYTHONPATH=.. python3 error_handling13.py
#
"""
      ...
      "Iterator": {
        ...
        "States": {
          "Validate": {
            ...
            "Parameters": {  
                "Input.$": "$",
                "StateMachineArn": "arn:aws:states:local:0123456789:stateMachine:wait60_state_machine"
            },
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="error_handling13")
    ...
    create_tracer("error_handling13", {"implementation": "Jaeger"})
    ...
    caller_state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling13"
    callee_state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:wait60_state_machine"
    ...
    def create_state_machines():
        ...
        try:
            response = sfn.create_state_machine(
                name="error_handling13", definition=ASL,
            ...
            response = sfn.create_state_machine(
                name="wait60_state_machine", definition=callee_ASL,
                roleArn="arn:aws:iam::0123456789:role/service-role/MyRole",
                loggingConfiguration={
                    "level": "ALL",
                    "includeExecutionData": True,
            ...
            response = sfn.update_state_machine(
                stateMachineArn=callee_state_machine_arn,
