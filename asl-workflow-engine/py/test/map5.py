...
This test is based on map2.py but adds a Fail State to deliberately fail.
"""
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="map5")
    ...
    create_tracer("map5", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:map5"
