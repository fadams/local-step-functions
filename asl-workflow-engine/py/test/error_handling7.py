...
#
# Run with:
# PYTHONPATH=.. python3 error_handling7.py
#
"""
...
This example is based on parallel4.py, but adds a Fail State to a nested branch
to deliberately fail and includes Parallel State Retriers and Catchers.
"""
...
ASL = """{
  ...
  "States": {
                ...
                },
                {
                  ...
                  "States": {
                    ...
                    "FailBranch1": {
                      "Type": "Fail",
                      "Error": "BranchFailed",
                      "Cause": "Branch failed! Reached FailState"
                    }
                  }
                }
              ]
    ...
    "CatchAllFailState": {
      "Type": "Fail",
      "Error": "CatchAll",
      "Cause": "Retries failed! Reached CatchAllFailState"
    },
    "EndState": {
        "Type": "Pass",
        "End": true
...
if __name__ == '__main__':
    # Initialise logger
    logger = init_logging(log_name="error_handling7")
    ...
    create_tracer("error_handling7", {"implementation": "Jaeger"})
    ...
    state_machine_arn = "arn:aws:states:local:0123456789:stateMachine:error_handling7"
    ...
    def create_state_machines():
        ...
        try:
            response = sfn.create_state_machine(
                name="error_handling7", definition=ASL,
